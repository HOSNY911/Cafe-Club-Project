...
set nocount on;
	begin Try
		...
		select U.UserID,P.FullName,U.UserName,U.Permissions,U.IsActive,P.Phone,U.CreatedAt,Createdby.UserName as Createdby,U.UpdatedAt,Updateby.UserName as Updatedby from Users as U
		Join
