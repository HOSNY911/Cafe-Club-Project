...
begin 
	...
	begin Try
		...
		select P.FullName,U.UserName,U.Permissions,U.IsActive,P.Phone,Createdby.UserName as Createdby,U.UpdatedAt,Updateby.UserName as Updatedby from Users as U
		Join
